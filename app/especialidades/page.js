                                        ...
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/cardiologia">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/cardiologia">Cardiología</Link>
                                                </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/cirugia-general">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/cirugia-general">Cirugía General</Link>
                                                </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/ginecologia">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/ginecologia">Ginecología</Link>
                                                </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/neumologia">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/neumologia">Neumología</Link>
                                                </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/nutricion">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/nutricion">Nutrición</Link>
                                                </h3>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                    <div className="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <div className="image-box">
                                                <figure className="image">
                                                    <Link href="especialidades/reumatologia">
                                            ...
                                            <div className="lower-content">
                                                <h3>
                                                    <Link href="especialidades/reumatologia">Reumatología</Link>
                                                </h3>
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="900ms" data-wow-duration="1500ms">
                                            <div className="inner-box">
                                                <div className="image-box">
                                                    <figure className="image">
                                                        <Link href="especialidades/traumatologia">
                                                ...
                                                <div className="lower-content">
                                                    <h3>
                                                        <Link href="especialidades/traumatologia">Traumatología</Link>
                                                    </h3>
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                                        <div className="service-block-one wow fadeInUp animated" data-wow-delay="1200ms" data-wow-duration="1500ms">
                                            <div className="inner-box">
                                                <div className="image-box">
                                                    <figure className="image">
                                                        <Link href="especialidades/urologia">
                                                ...
                                                <div className="lower-content">
                                                    <h3>
                                                        <Link href="especialidades/urologia">Urología</Link>
                                                    </h3>
