          ...
          <div className="menu-outer">
            <div
              ...
              <ul className="navigation clearfix">
                ...
                <li><Link href="/sobre-nosotros" onClick={handleMobileMenu}>Nosotros</Link></li>
                <li><Link href="/especialidades" onClick={handleMobileMenu}>Especialidades</Link></li>
                ...
                <li><Link href="/contactanos" onClick={handleMobileMenu}>Contactanos</Link></li>
                <li><Link href="/cursos" onClick={handleMobileMenu}>Cursos</Link></li>
              </ul>
            </div>
          </div>
